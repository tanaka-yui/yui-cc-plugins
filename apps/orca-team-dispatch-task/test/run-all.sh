...
set -uo pipefail
cd "$(dirname "$0")/.."
SUITE="test-start test-config test-send test-wake test-issue-fetch test-issue test-pr test-completion test-recover test-stop test-wait test-merge test-cleanup test-report-status test-docs test-e2e"
rc=0
